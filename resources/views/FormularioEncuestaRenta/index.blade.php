...
<body>
    <form action="/Formulario-Renta" method="POST" enctype="multipart/form-data">
        {{ csrf_field() }}
        <div class="container border">
            <h1 class="text-center">ENCUESTA DE RENTA</h1>
            <div class="form-row">
                ...
                <div class="form-group col-md-6 shadow-none p-3 mb-5 bg-light rounded">
                    ...
                    <input type="number" min="0" name="IDInmueble" class="form-control border-danger" id="inputEmail4"
                        placeholder="ingresa id del inmueble" required>
                </div>
                ...
                <div class="form-check col-md-6">
                    <div class="text-center shadow p-3 mb-5 bg-white rounded">
                        <h5 class="mb-3">¿Como le parecio el servicio prestado por el agente de METRO RED INMOBILIARIA?
                        </h5>
                ...
                <div class="form-check col-md-6 text-center mb-3">
                    <div class="text-center shadow p-3 mb-5 bg-white rounded">
                        ...
                        <input type="text" name="AcuerdoValordeVenta" class="form-control border-danger" id="valor"
                            placeholder="ingrese la opinion del valor" required>
                    </div>
                ...
                <div class="form-check col-md-6 text-center mb-3">
                    <div class="text-center shadow p-3 mb-5 bg-white rounded">
                        ...
                        <input type="text" name="OfertaInmueble" class="form-control  border-danger" id="oferta"
                            placeholder="ingrese la opinion sobre la oferta" required>
                    </div>
                ...
                <div class="form-check col-md-6 text-center shadow-none p-3 mb-5 bg-light rounded">
                    ...
                    <input type="text" name="ReferidoNombre" class="form-control mb-3 border-danger" id="nombre1"
                        placeholder="Nombre" required>
                    <input type="number" min="0" name="ReferidoTelefono" class="form-control mb-3 border-danger"
                ...
                <div class="form-check col-md-6 text-center shadow-none p-3 mb-5 bg-light rounded">
                    ...
                    <input type="text" name="ReferidoNombre2" class="form-control mb-3 border-danger" id="nombre2"
                        placeholder="Nombre" required>
                    <input type="number" min="0" name="ReferidoTelefono2" class="form-control mb-3 border-danger"
                        id="telefono2" placeholder="Telefono" required>
                </div>
                <div class="form-check col-md-12 text-center">
                ...
                <div class="form-check col-md-6 text-center mb-3">
                    <div class="text-center shadow p-3 mb-5 bg-white rounded">
                        ...
                        <input type="text" name="NombreCliente" class="form-control mb-3 border-danger" id="clienten"
                            placeholder="Nombre" required>
                        <div class="row">
                            <div class="col">
                                <input type="number" min="0" name="CedulaCliente"
                                    class="form-control mb-3 border-danger" id="clientec" placeholder="Cedula" required>
                            </div>
                            <div class="col">
                                <input type="number" min="0" name="TelefonoCliente"
                                    class="form-control mb-3 border-danger" id="clientet" placeholder="Telefono-Celular"
                                    required>
                            </div>
                        </div>
                        <input type="email" name="MailCliente" class="form-control mb-3 border-danger" id="clientee"
                            placeholder="E-MAIL" required>
                        <div class="custom-file">
                            <input type="file" name="FirmaCliente" class="custom-file-input border-danger"
                                id="clientef">
                ...
                <div class="form-check col-md-6 text-center mb-3">
                    <div class="text-center shadow p-3 mb-5 bg-white rounded">
                        ...
                        <input type="text" name="NombrePropietario" class="form-control mb-3 border-danger"
                            id="propietarion" placeholder="Nombre" required>

                        <div class="row">
                            <div class="col">
                                <input type="number" min="0" name="CedulaPropietario"
                                    class="form-control mb-3 border-danger" id="propietarioc" placeholder="Cedula"
                                    required>
                            </div>
                            <div class="col">
                                <input type="number" min="0" name="TelefonoPropietario"
                                    class="form-control mb-3 border-danger" id="propietariot"
                                    placeholder="Telefono-Celular" required>
                            </div>
                            <input type="email" name="MailPropietario" class="form-control mb-3 border-danger"
                                id="propietarioe" placeholder="E-MAIL" required>
                            <div class="custom-file">
